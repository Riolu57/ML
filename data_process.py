...
class Data:
    def __init__(self, train_perc, lookback, file_path='TBP_dataset.csv', max_size=False, expand=True):
        self.train_perc = train_perc
        self.lookback = lookback
        self.path = file_path
        self.max_size = max_size
        self.data = self.read_data()
        self.expand_bool = expand

        self.train_data, self.test_data = self.train_test_split(self.max_size)
    ...
    def read_data(self):
        ...
        data = df[['pos1_x', 'pos1_y', 'v1_x', 'v1_y', 'pos2_x', 'pos2_y', 'v2_x', 'v2_y', 'pos3_x', 'pos3_y', 'v3_x',
                   'v3_y']][0:self.max_size].values.tolist()
        return data
